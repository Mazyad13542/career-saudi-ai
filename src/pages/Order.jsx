...
import { CheckCircle, ShoppingCart, User, Phone, Mail, Briefcase, Clock, Link2, ChevronLeft } from 'lucide-react';
...
export default function Order() {
  ...
  const handleSubmit = (e) => {
    ...
    const msg = [
      ...
      '',
      '✅ الخدمات المطلوبة: الباقة الكاملة (١٩٩ ر.س)',
    ].filter(Boolean).join('\n');
            ...
            <div className="bg-white rounded-3xl border border-gray-100 shadow-xl p-7 sm:p-8">
              ...
              <form onSubmit={handleSubmit} className="space-y-5">
                ...
                <p className="text-center text-xs text-gray-400">
                  ستُحوَّل إلى واتساب تلقائياً · التسليم خلال ٨ ساعات
                </p>
              </form>
            </div>
          </div>
